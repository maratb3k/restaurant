package com.epam.edp.demo.exception.handler;

import com.epam.edp.demo.exception.*;
...
public class GlobalHandler {
    ...
    public ResponseEntity<ApiResponse> handleUserNotFound(com.epam.edp.demo.exception.UserNotFoundException ex) {
...
//    @ExceptionHandler(com.amazonaws.services.kms.model.NotFoundException.class)
//    public ResponseEntity<ApiResponse> handleAwsNotFound(com.amazonaws.services.kms.model.NotFoundException ex) {
//        System.out.println("=====. handleAwsNotFound ====== ");
//
//        ApiResponse response = ApiResponse.builder()
//                .statusCode(404)
//                .success(false)
