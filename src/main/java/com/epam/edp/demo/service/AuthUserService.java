...
import com.epam.edp.demo.model.dto.request.UserCreateRequest;
import com.epam.edp.demo.model.dto.request.UserLoginRequest;
...
public class AuthUserService {
    ...
    public ApiResponse register(UserCreateRequest request) throws JsonProcessingException {
        ...
        // check if user with the given email exists, if so throw exception
        ...
        //Sign up the user
        //If the email is registered as waiter assign waiter role
