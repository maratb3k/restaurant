...
import com.restaurant.booking.mapper.LocationMapper;
...
import com.restaurant.booking.model.dto.response.FeedbackResponse;
import com.restaurant.booking.model.dto.response.LocationResponse;
import com.restaurant.booking.model.dto.response.LocationSelectionResponse;
...
public class LocationService {
    ...
    public ApiResponse getFeedbacksByLocation(FeedbacksByLocationRequest request, String locationId) throws Exception {
        ...
        if (comparator != null) {
            allFeedbacks.sort(request.getAscending() ? comparator : comparator.reversed());
        }
        ...
        List<FeedbackResponse> feedbackResponses = mapToFeedbackResponse(feedbacks, request.getFeedbackType());
