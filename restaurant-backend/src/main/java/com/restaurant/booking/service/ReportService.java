...
import com.restaurant.booking.model.constant.PerformanceType;
...
public class ReportService {
    ...
    public Reports generateReports(String performanceType, String startTime, String endTime, String locationId) {
        try {
            ...
            String link = minioStorageService.uploadCsvAndGetDownloadUrl(fileName, csvContent);
            reportMetric.setDownloadLink(link);
            sendToKafka(reportMetric);
            return reportMetric;
        } catch (Exception e) {
